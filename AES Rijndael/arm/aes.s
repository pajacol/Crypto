.globl aes128_key_schedule @ void aes128_key_schedule(unsigned char key[176])
.globl aes192_key_schedule @ void aes192_key_schedule(unsigned char key[208])
.globl aes256_key_schedule @ void aes256_key_schedule(unsigned char key[240])
.globl aes128_key_inverse  @ void aes128_key_inverse(unsigned char key[176])
.globl aes192_key_inverse  @ void aes192_key_inverse(unsigned char key[208])
.globl aes256_key_inverse  @ void aes256_key_inverse(unsigned char key[240])
.globl aes128_encrypt      @ void aes128_encrypt(unsigned char buffer[16], const unsigned char key[176])
.globl aes192_encrypt      @ void aes192_encrypt(unsigned char buffer[16], const unsigned char key[208])
.globl aes256_encrypt      @ void aes256_encrypt(unsigned char buffer[16], const unsigned char key[240])
.globl aes128_decrypt      @ void aes128_decrypt(unsigned char buffer[16], const unsigned char key[176])
.globl aes192_decrypt      @ void aes192_decrypt(unsigned char buffer[16], const unsigned char key[208])
.globl aes256_decrypt      @ void aes256_decrypt(unsigned char buffer[16], const unsigned char key[240])
